...
import (
	...
	yccompute "github.com/yandex-cloud/go-genproto/yandex/cloud/compute/v1"
...
func TestVirtualMachineAvailability(t *testing.T) {
	...
	terraformOptions := &terraform.Options{
		...
		Vars: map[string]interface{}{
			"cloud_id":         os.Getenv("TF_VAR_cloud_id"),
			"folder_id":        os.Getenv("TF_VAR_folder_id"),
	...
	instances, err := computeService.List(ctx, &yccompute.ListInstancesRequest{
